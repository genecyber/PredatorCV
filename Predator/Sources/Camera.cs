...
namespace PredatorCV.Sources
{
        ...
        ISource
    {
        ...
        /// </summary>
        private FLIP _flipType = FLIP.NONE;
        ...
        public bool FlipHorizontal
        {
            get
            {
                return (_flipType & FLIP.HORIZONTAL) == FLIP.HORIZONTAL;
            }
            set
            {
                if (value != FlipHorizontal)
                    _flipType ^= FLIP.HORIZONTAL;
            }
        }
        ...
        public bool FlipVertical
        {
            get
            {
                return (_flipType & FLIP.VERTICAL) == FLIP.VERTICAL;
            }
            set
            {
        ...
        public int Width
        {
            get
            {
                return Convert.ToInt32(GetCaptureProperty(CAP_PROP.CV_CAP_PROP_FRAME_WIDTH));
            }
        }
        ...
        public int Height
        {
            get
            {
                return Convert.ToInt32(GetCaptureProperty(CAP_PROP.CV_CAP_PROP_FRAME_HEIGHT));
            }
        }
        #endregion
